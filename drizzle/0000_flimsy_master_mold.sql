...
CREATE INDEX "cards_deck_id_position_idx" ON "cards" USING btree ("deck_id","position");--> statement-breakpoint
CREATE INDEX "decks_clerk_user_id_idx" ON "decks" USING btree ("clerk_user_id");